  ...
  ?>
    ...
    <div class="columns">
      <div class="column is-two-fifths">
        <?php // este caso cuando la imagen existe y se puede eliminar 
        if (is_file("./img/producto/" . $datos['producto_foto'])) { ?>

          <figure class="image mb-6">
            <img src="./img/producto/<?php echo $datos['producto_foto']; ?>">
          </figure>
          <form class="FormularioAjax" action="./php/producto_img_del.php" method="POST" autocomplete="off">
        ...
        <?php } else {
          // Este caso cuando la imagen no existe, 
          // se muestra la imagen por defecto y se puede seleccionar una imagen para subir
        ?>
          <figure class="image mb-6">
      ...
      <div class="column">
        <form class="mb-6 has-text-centered FormularioAjax" action="./php/producto_img_up.php"
