...
# Conexion a la base de datos de mysql con PDO #
function conexion()
{
...
function paginador_tablas($pagina, $total_paginas, $url, $num_botones)
{
  ...
  if ($pagina == $total_paginas) {
    ...
    $tabla .= '
      <li><span class="pagination-ellipsis">&hellip;</span></li>      
      <li><a href="' . $url . $total_paginas . '" class="pagination-link">' . $total_paginas . '</a></li>
      </ul>
